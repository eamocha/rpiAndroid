...
public class PopUpActivity extends YouTubeBaseActivity {
    ...
    private void playCoursePreview() { //Log.e("provider",mCourse.getCourseOverviewProvider());
...
Log.d("AIzaSyCwknTgRMY-Yaax99DW3dyLeLTu06htgfo", "error occured"+youTubeInitializationResult.toString());
            }
        };
        ...
        myouTubePlayerView.initialize("AIzaSyCwknTgRMY-Yaax99DW3dyLeLTu06htgfo", mOnInitializedListener);
    }

    private void playVimeoOnWebView() {
       // Log.d("vimeo code",mCourse.getCourseOverviewUrl());
